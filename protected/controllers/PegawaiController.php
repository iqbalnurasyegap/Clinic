...
class PegawaiController extends Controller
{
	...
	{
		$model = new Pegawai;  // Membuat model Pegawai baru

		// Mengecek jika ada data yang dikirimkan via form
		if (isset($_POST['Pegawai'])) {
			$model->attributes = $_POST['Pegawai'];  // Menetapkan data form ke model
			if ($model->save()) {
				// Jika data berhasil disimpan, arahkan ke halaman index
